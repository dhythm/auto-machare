...
const personas: Persona[] = [
  { id: 'nakamura-motors', name: '中村モータース' },
  { id: 'sato-auto', name: '佐藤オート' },
  { id: 'tamura', name: '田村さん' },
  { id: 'kobayashi-trading', name: '小林商会' },
  { id: 'sky-lease', name: 'スカイリース' },
  { id: 'tokachi-auto', name: '十勝オート' },
  { id: 'takahashi', name: '高橋さん' },
  { id: 'yamada-cars', name: '山田カーズ' },
  { id: 'midori-motors', name: 'みどり自動車' },
  { id: 'watanabe', name: '渡辺さん' },
  { id: 'suzuki', name: '鈴木さん' },
  { id: 'ito-motors', name: '伊藤モーターズ' },
  { id: 'kato', name: '加藤さん' },
  { id: 'hokuriku-carrier', name: '北陸陸送' },
